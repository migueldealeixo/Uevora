   ...
   public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
       http
           ...
           .authorizeHttpRequests(auth -> auth
               ...
               .requestMatchers("/aceitarViagem","/remover","/procurarPassageiro","/passageiroViagens","/removerPedido","/procurarCondutor","/aprovar","/desaprovar","/join","/viagenspedidas","/viagensdisponiveis", "/leave","/search","/showRotas").authenticated()
