...
public class MetricaController {
    ...
    @GetMapping("/piso/media/temperatura/{piso}")
    ...
    public double mediaTemperaturaEdificio(@PathVariable String edificio) {
        return metricaService.mediaPorEdificio(edificio);
    }
    @GetMapping("/edificio/media/humidade/{edificio}")
    public double mediaHumidadeEdificio(@PathVariable String edificio) {
